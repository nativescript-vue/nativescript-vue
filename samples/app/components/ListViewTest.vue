<template>
  <Page>
    <ListView for="item in listItems" separatorColor="transparent">
      ...
      <v-template if="item.type === 'post.image.single'">
        <ListItem :item="item" @toggleLike="togglePostLike(item)">
          <GridLayout rows="auto, auto">
            ...
            <Label backgroundColor="red" height="200" stretch="aspectFill" row="1" />
          </GridLayout>
        </ListItem>
      </v-template>
      ...
      <v-template if="item.type === 'post.image.double'">
        <ListItem :item="item" @toggleLike="togglePostLike(item)">
          <GridLayout rows="auto, auto" columns="*, *">
            ...
            <Label backgroundColor="red" height="200" stretch="aspectFill" col="0" row="1" />
            <Label backgroundColor="green" height="200" stretch="aspectFill" col="1" row="1" />
          </GridLayout>
        </ListItem>
      </v-template>
        ...
        <ListItem :item="item" @toggleLike="togglePostLike(item)">
          <GridLayout rows="auto, auto, auto" columns="2*, *">
            ...
            <Label
              ...
              rowspan="2"
            />
            <Label backgroundColor="green" height="100" stretch="aspectFill" col="1" row="1" />
            <Label backgroundColor="blue" height="100" stretch="aspectFill" col="1" row="2" />
          </GridLayout>
        </ListItem>
      </v-template>
